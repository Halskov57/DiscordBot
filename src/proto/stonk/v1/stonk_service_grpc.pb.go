...
type StonkServiceClient interface {
	...
	Gainers(ctx context.Context, in *GainersRequest, opts ...grpc.CallOption) (*GainersResponse, error)
	Loosers(ctx context.Context, in *LoosersRequest, opts ...grpc.CallOption) (*LoosersResponse, error)
...
func (c *stonkServiceClient) Gainers(ctx context.Context, in *GainersRequest, opts ...grpc.CallOption) (*GainersResponse, error) {
	out := new(GainersResponse)
	err := c.cc.Invoke(ctx, "/stonk.v1.StonkService/Gainers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stonkServiceClient) Loosers(ctx context.Context, in *LoosersRequest, opts ...grpc.CallOption) (*LoosersResponse, error) {
	out := new(LoosersResponse)
	err := c.cc.Invoke(ctx, "/stonk.v1.StonkService/Loosers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stonkServiceClient) Compare(ctx context.Context, in *CompareRequest, opts ...grpc.CallOption) (*CompareResponse, error) {
	out := new(CompareResponse)
	err := c.cc.Invoke(ctx, "/stonk.v1.StonkService/Compare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StonkServiceServer interface {
	...
	Gainers(context.Context, *GainersRequest) (*GainersResponse, error)
	Loosers(context.Context, *LoosersRequest) (*LoosersResponse, error)
...
func (UnimplementedStonkServiceServer) Gainers(context.Context, *GainersRequest) (*GainersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Gainers not implemented")
}
func (UnimplementedStonkServiceServer) Loosers(context.Context, *LoosersRequest) (*LoosersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Loosers not implemented")
}
...
func _StonkService_Gainers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GainersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StonkServiceServer).Gainers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stonk.v1.StonkService/Gainers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StonkServiceServer).Gainers(ctx, req.(*GainersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StonkService_Loosers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoosersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StonkServiceServer).Loosers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stonk.v1.StonkService/Loosers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StonkServiceServer).Loosers(ctx, req.(*LoosersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StonkService_Compare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompareRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StonkServiceServer).Compare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stonk.v1.StonkService/Compare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StonkServiceServer).Compare(ctx, req.(*CompareRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StonkService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Gainers",
			Handler:    _StonkService_Gainers_Handler,
		},
		{
			MethodName: "Loosers",
			Handler:    _StonkService_Loosers_Handler,
		},
		{
			MethodName: "Compare",
			Handler:    _StonkService_Compare_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "stonk/v1/stonk_service.proto",
}
